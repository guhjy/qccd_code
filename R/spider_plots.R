...
colnames(igci_acc_df) = c("SIM", "SIM \n -ln", "SIM \n -G", "AN \n -G", "AN \n -s","HN", "HN \n -s", "MN \n -U", "MN \n -G", "Tueb")
...
colnames(slope_acc_df)= c("SIM", "SIM \n -ln", "SIM \n -G", "AN \n -G", "AN \n -s","HN", "HN \n -s", "MN \n -U", "MN \n -G", "Tueb")
